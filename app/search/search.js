...
export default function Search() {
    ...
    if(!loading) {
        content = (
            items.map((item) => {
                ...
                className = "w-full flex items-center hover:bg-gray-200 my-1 p-1 dark:hover:bg-slate-400">
                    ...
                    <div className="text-left dark:text-slate-300">
    ...
    return (
        <main className="pl-10 pr-10 dark:bg-slate-600">
